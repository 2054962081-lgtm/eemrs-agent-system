...
@Component
public class AgentTraceSchemaInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        try {
            ...
            // Trace schema is best-effort. Agent business endpoints must remain available when MySQL is down.
        }
    }
}
